...
GROUPS: list[dict[str, Any]] = [
    {
        ...
        "fields": [
            ...
            {"key": "company.logo_url", "label": "Logo URL", "type": "image"},
            {"key": "company.favicon_url", "label": "Favicon URL", "type": "image"},
    ...
    },
    {
        "key": "backup",
        "name": "Backup Policy",
        "description": "Scheduled backups + retention + off-site cloud copy.",
        "icon": "HardDrive",
        "fields": [
            # Phase 42 - new schedule + R2 fields.
            {"key": "backup.daily_enabled",
             "label": "Daily backup enabled",
             "type": "checkbox", "default": False},
            {"key": "backup.daily_time",
             "label": "Daily backup time (UTC, HH:MM)",
             "type": "text", "default": "23:00"},
            {"key": "backup.weekly_enabled",
             "label": "Weekly cloud backup enabled",
             "type": "checkbox", "default": False},
            {"key": "backup.weekly_day",
             "label": "Weekly backup day", "type": "select",
             "options": [
                 "Monday", "Tuesday", "Wednesday", "Thursday",
                 "Friday", "Saturday", "Sunday",
             ],
             "default": "Sunday"},
            {"key": "backup.weekly_time",
             "label": "Weekly backup time (UTC, HH:MM)",
             "type": "text", "default": "23:30"},
            {"key": "backup.local_folder",
             "label": "Local backup folder (absolute path)",
             "type": "text",
             "help": "Leave empty to use the BACKUP_FOLDER env var. Must exist and be writable by the backend process."},
            {"key": "backup.cloud_provider",
             "label": "Cloud provider", "type": "select",
             "options": ["", "cloudflare_r2"], "default": ""},
            {"key": "backup.cloud_folder",
             "label": "Cloud bucket + prefix",
             "type": "text",
             "placeholder": "pugfinapp/legal-backup",
             "help": "Just bucket/prefix (the s3:// scheme is optional). The HTTPS endpoint goes in 'S3 Endpoint' on the Integrations card."},
            # Legacy retention knobs kept for backwards-compat.
            ...
            {"key": "backup.offsite_s3_url",
             "label": "Offsite S3 URL (legacy)",
             "type": "text",
             "placeholder": "s3://bucket/path",
             "help": "Optional legacy field. Prefer 'Cloud bucket + prefix' above for the destination, and put the HTTPS endpoint on the Integrations card."},
